...
class Layer0(nn.Module):
    def __init__(self, num_channels=3, out_planes=64):
        super(Layer0, self).__init__()
        self.conv1 = nn.Conv2d(num_channels, out_planes, kernel_size=3,
                               stride=1, padding=1, bias=False)
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_channels=3, num_classes=10):
        ...
        self.in_planes = 64
        self.layer0 = Layer0(num_channels=num_channels, out_planes=self.in_planes)
...
def ResNet18(num_channels=3, num_classes=10):
    return ResNet(BasicBlock, [2, 2, 2, 2], num_channels=num_channels, num_classes=num_classes)
